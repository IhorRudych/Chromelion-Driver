...
//
// Driver class for the SimpleDriver.
...
namespace MyCompany.SimpleDriver
{
    ...
    public class Driver : IDriver
    {
        ...
        /// Our SimpleDevice.
        private SimpleDevice m_MyDevice;
        ...
        public Driver()
        {
            ...
            try
            {
                ...
                xmlStream = this.GetType().Assembly.GetManifestResourceStream
                    ("MyCompany.SimpleDriver.DefaultConfig.xml");
        ...
        public void Init(IDDK cmDDK)
        {
            ...
            // Create our device.
            m_MyDevice = new SimpleDevice();
            m_MyDevice.Create(cmDDK, m_ConfigParser.GetDeviceName("Simple Device"));
        }
        ...
        public void Connect()
        {
            ...
            // Our SimpleDevice implementation implements a method OnConnect that will fill
            // a property.
