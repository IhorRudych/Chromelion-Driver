            ...
            : base(driver, ddk, typeof(Pump).Name, id, config.Name)
        {
            ...
            try
            {
                ...
                string text = Environment.NewLine + Environment.NewLine +
                    "m_FlowHandler.FlowNominalProperty   .IsRampSyntax = " + m_FlowHandler.FlowNominalProperty.IsRampSyntax.ToString() + Environment.NewLine +     // True
                    "m_FlowHandler.FlowValueProperty     .IsRampSyntax = " + m_FlowHandler.FlowValueProperty.IsRampSyntax.ToString() + Environment.NewLine +       // True
                    "m_FlowHandler.ComponentProperties[0].IsRampSyntax = " + m_FlowHandler.ComponentProperties[0].IsRampSyntax.ToString() + Environment.NewLine +  // False
                    "m_FlowHandler.ComponentProperties[1].IsRampSyntax = " + m_FlowHandler.ComponentProperties[1].IsRampSyntax.ToString() + Environment.NewLine +  // True
                    "m_FlowHandler.ComponentProperties[2].IsRampSyntax = " + m_FlowHandler.ComponentProperties[2].IsRampSyntax.ToString() + Environment.NewLine +  // True
                    "m_FlowHandler.ComponentProperties[3].IsRampSyntax = " + m_FlowHandler.ComponentProperties[3].IsRampSyntax.ToString() + Environment.NewLine +  // True
                     Environment.NewLine;
